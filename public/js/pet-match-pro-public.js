...
;(function ($, window, document, undefined)
{
    "use strict";
        ...
        var pluginName = "PMPpaginate",
            defaults = {
                itemsPerPage: 15,
                itemsContainer: ".items",
                item: "> div",
                page: 1,
                nextPage: ".pmp-nextPage",
                previousPage: ".pmp-previousPage", 
                firstPage: ".pmp-firstPage",
                lastPage: ".pmp-lastPage",
                pageNumbers: ".pmp-pageNumbers",
        ...
        function paginga(element, options)
        {
            ...
            this.species = this.settings.species;
            ...
            showPage: function()
            {
                ...
                if(pageNumbers)
                {
                    ...
                    for(var pageNumber = firstPage; pageNumber <= lastPage; pageNumber++)
                    {
                        ...
                        //removed className + and replaced with species
                        pageNumbers.append("<a href='javascript:void(0);' data-page='" + pageNumber + "' class='pmp-page-link" +  this.species + " pmp-page-link-" + pageNumber + this.species + "' id='pmp-page-link-" + pageNumber + this.species + "' >" + pageNumber + "</a>");
                    }
